                ...
                <div class="card-body p-0">
                    <div class="row justify-content-between">
                        <div class="col-md-3 col-6">
                            <h3 class="text-color fw-bold">Active Promotions</h3>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-light fs-4 d-flex align-items-center justify-content-center gap-2 p-2 px-4 w-125px"
                                            href="{{ route('promotion.basic_deal',['type'=>'campaign']) }}" data-bs-toggle="modal"
                                            data-bs-target="#global_modal" data-bs-whatever="Create Campaign">
