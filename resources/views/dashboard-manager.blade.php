                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-body pt-2">
                        <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6 dashboard-manager">
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 active" data-bs-toggle="tab" href="#arrivals">
                                    <span class="material-symbols-outlined fs-3">
                                        flight_land
                                    </span>
                                    Arrivals
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2" data-bs-toggle="tab" href="#departures">
                                    <span class="material-symbols-outlined fs-3">
                                        flight_takeoff
                                    </span>
                                    Departures
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2" data-bs-toggle="tab" href="#stay-overs">
                                    <span class="material-symbols-outlined fs-3">
                                        hotel
                                    </span>
                                    Stay-overs
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="arrivals" role="tabpanel">
                                <a href="{{ route('hotelmanager.dashboard') }}">Managers</a>
                            </div>
