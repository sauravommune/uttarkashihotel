            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                ...
                <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separator-less fw-semibold fs-7 my-0">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-color-secondary">Bed Type List</li>
                        <!--end::Item-->
                    </ul>
                </div>
                <!--end::Page title-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('add.bedType') }}" data-bs-toggle="modal" data-bs-target="#global_modal"
                        data-bs-whatever="Add Bed Type" class="btn btn-sm btn-flex btn-primary h-40px fs-7 fw-bold">
