    ...
    <div class="sections">
        ...
        <div class="header">
            <table style="width: 100%; border-collapse: collapse; border:0px;">
                <tr>
                    <td style="width: 30%; text-align: left; border:0px; padding:0px;">
                        <img src="{{ !empty($message) ? $message->embed(asset('assets/front/images/black-logo.svg')) : asset('assets/front/images/black-logo.svg') }}#" alt="Logo" style="width: 150px;">
                    </td>
                    <td style="width: 70%; text-align: right; border:0px;">
                        <p style="margin: 0; font-weight: bold; font-size: 16px;">Payment Receipt</p>
                        @if(!empty($booking->invoice?->invoice_number))
                            <p style="margin: 5px 0; font-size: 14px; padding-top: 2px;">
                                Receipt No.: {{ $booking->invoice->invoice_number }}
                            </p>
                        @endif
                        <p style="margin: 0; font-size: 14px; padding-top: 2px;">Date: {{ formatDateMdY($booking->invoice?->invoice_date) }}</p>
                    </td>
                </tr>
            </table>
        </div>
        <div style="border-top:1px solid #D9D9D9; margin-top: 50px; padding-top: 5px">
                    ...
                    <table>
                        <tr>
                            ...
                            <td style="border:0px; padding:0px; font-size:12px; color:#3E4C56; padding-bottom:10px;">
                                : <a href="{{ $booking?->hotel?->map_url }}" style="color:#1A1F24; text-decoration: none;" target="_blank"><strong>{{ $booking?->hotel?->name }}</strong></a>
                            </td>
                        </tr>
                        <tr>
        ...
        <div style="border-top:1px solid #D9D9D9; margin-top:0px; padding-top: 10px">
            <h2 style="color:#1A1F24; font-size: 16px; font-weight: bold;">Customer Detail</h2>
            <div style="width: 50%; float: left;">
                <table>
                    <tr>
                        <th style="border:0px; padding:0px; font-size:14px; font-weight:600; color:#3E4C56; padding-bottom:10px;">Name</th>
                        <td style="border:0px; padding:0px; font-size:14px; color:#3E4C56; padding-bottom:10px;">: {{ $booking?->bookingContact?->name }}</td>
                    </tr>
                    <tr>
                        <th style="border:0px; padding:0px; font-size:14px; font-weight:600; color:#3E4C56; padding-bottom:10px;">Email</th>
                        <td style="border:0px; padding:0px; font-size:14px; color:#3E4C56; padding-bottom:10px;">: {{ $booking?->bookingContact?->email }}</td>
                    </tr>
                    <tr>
                        <th style="border:0px; padding:0px; font-size:14px; font-weight:600; color:#3E4C56; padding-bottom:10px;">Booking ID</th>
                        <td style="border:0px; padding:0px; font-size:14px; color:#3E4C56; padding-bottom:10px;">: {{ $booking->booking_id }}</td>
                    </tr>
                    <tr>
                        <th style="border:0px; padding:0px; font-size:14px; font-weight:600; color:#3E4C56; padding-bottom:10px;">Total Rooms</th>
                        <td style="border:0px; padding:0px; font-size:14px; color:#3E4C56; padding-bottom:10px;">: {{ $booking?->total_room }}</td>
                    </tr>
                </table>
            </div>
            <div style="width: 50%; float: left;">
                <table>
                    <tr>
                        <th style="border:0px; padding:0px; font-size:14px; font-weight:600; color:#3E4C56; padding-bottom:10px;">Travel Date</th>
                        <td style="border:0px; padding:0px; font-size:14px; color:#3E4C56; padding-bottom:10px;">
                    ...
                    <tr>
                        <th style="border:0px; padding:0px; font-size:14px; font-weight:600; color:#3E4C56; padding-bottom:10px;">Total Guest</th>
                        <td style="border:0px; padding:0px; font-size:14px; color:#3E4C56; padding-bottom:10px;">: {{ $booking?->total_guest }}</td>
                    </tr>
                </table>
            </div>
        </div>
        ...
        <div style="border-bottom:1px solid #D9D9D9; border-top:1px solid #D9D9D9;">
            <table style="margin-bottom:0px;">
                <tr>
                    <td style="color:#1A1F24; font-size: 16px; font-weight: bold;  padding-bottom:20px; padding-top:20px; border:0px; padding-left:0px; ">
                        Total Amount Collected on Behalf of Hotel
                    </td>
                    <td style="border:0px; padding:0px; font-size:16px; color:#3E4C56; padding-top:20px; text-align:right; padding-bottom:20px; font-weight:500;  border:0px; ">₹ {{$booking?->bookedRooms->sum('total_price')}}</td>
                </tr>
            </table>
        </div>
        <div style="clear: both"></div>
