                        ...
                        <div class="room-img" id="room-img">
                            ...
                            @else
                                <a href="{{ asset('assets/media/no-hotel-img.svg') }}" data-bs-toggle="modal"
                                    ...
                                    <div class="image bg-image-style lazy"
                                        data-bg="{{ asset('assets/media/no-hotel-img.svg') }}"></div>
                                </a>
                            @endif
                        </div>
                    </div>
                                    ...
                                    <ul class="mt-3 main-ul">
                                        ...
                                        @if (count($room['rooms']['addAmenity']) > 4)
                                            <li><a data-bs-toggle="modal"
                                                    data-bs-target="#room-amenities_{{ $index }}"
                                                    href="javascript:void(0);"
                                                    title="More amenities">{{ count($room['rooms']['addAmenity']) - 4 }}
                                                    more</a></li>
                                        @endif
                                    </ul>
                                @endif
                                            ...
                                            <div class="col-12 col-sm-6 col-md-3 col-xl-3">
                                                <a href="javascript:void(0);"
                                                    ...
                                                    <div class="gallery-img-modal">
                                                        <img src="{{ asset('storage/' . $roomImg->image) }}"
                                                            alt="{{ ImageAltTag($room['rooms']?->hotel, $roomImg->alt_tag) }}"
                                                            class="img-fluid">
                                                    </div>
                                                </a>
                                            </div>
                                                ...
                                                <a href="{{ asset('storage/' . $hotelImg['image']) }}"
                                                    ...
                                                    <div class="gallery-img-modal">
                                                        <img src="{{ asset('assets/media/no-hotel-img.svg') }}"
                                                            alt="{{ ImageAltTag($room['rooms']?->hotel, $hotelImg->alt_tag) }}"
                                                            class="img-fluid">
                                                    </div>
                                                </a>
                                            @endif
                            ...
                            <div class="row d-flex justify-content-center">
                                <div class="col-12">
                                    <div class="top-slider">
                                        ...
                                        <button type="button"
                                            class="btn-close hidden-btn btn-close-{{ $index }}"
                                            data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                </div>
                            </div>
