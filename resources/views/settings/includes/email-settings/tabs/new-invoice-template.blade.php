<div class="tab-pane show active px-7" id="new_invoice_template" role="tabpanel">
    <form id="new_invoice_email_form">
        <!--begin::Row-->
        <div class="row">
            <div class="col-xl-12 my-2">
                    ...
                    <div class="col-9">
                        <div class="input-group input-group-lg input-group-solid">
                            ...
                            <input type="text" class="form-control form-control-lg form-control-solid" name="subject"
                                value="{{ $adminsetting->email_settings['mails']['invoice_created']['subject'] }}"
                                placeholder="Your Invoice is Here!">
                        </div>
                    </div>
                </div>
                <!--end::Group-->
                ...
                <div class="col-12 text-center">
                    <button type="submit" id="new_invoice_email_form_submit" class="btn btn-light-primary font-weight-bold">
                        Save</button>
                </div>
            </div>
        </div>
