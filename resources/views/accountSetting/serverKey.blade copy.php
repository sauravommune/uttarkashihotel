     ...
     <div class="section-lead section-general p-4">
        <div class="card">
            <div class="d-flex justify-content-between card-section pb-3 align-items-center">
                <div>
                    <h5 class="d-flex align-items-center mb-0">API Settings</h5>
                </div>
                <div>
                    <button type="submit" onclick="window.history.back()" class="btn btn-primary fw-semibold">Back</button>
                </div>
            </div>
            <div class="row">
                    ...
                    <form action="{{ route('serverKey.store') }}" class="global-ajax-form" method="POST">
                        ...
                        <div class="row fv-plugins-icon-container">
                            ...
                            <div class="mb-3 col-12">
                                ...
                                <div class="input-group">
                                    <input type="text" id="apikey" class="form-control"
                                        placeholder="Server Key" name="key">
                                    <button type="button" class="input-group-text cursor-pointer"
                                        toggle="#currentPassword" id="keygen">Generate
                                        API Key</button>
                                </div>
                            </div>
                            ...
                            <div class="col-12 mt-3">
                                <button type="submit" id="submit_keyForm"
                                    class="btn btn-primary me-2 d-grid w-100 waves-effect waves-light">Create
                                    Key</button>
                            </div>
                        </div>
                    </form>
                ...
                <div class="col-12 col-lg-6 d-flex align-items-center mt-lg-0 mt-3">
                    <div class="d-flex justify-content-center w-100">
                        <img src="{{ asset('assets/images/girl-with-laptop.png') }}" alt="Api Key Image" width="310">
                    </div>
                </div>
            </div>
        </div>
